...
//     let answer = -1;//처음엔 포인터 변경이 필요 없으므로
//     const pointerMove = 1;
//     for(let i of name) {
//         if(i ==='A' || i === 'Z'){
//             answer += pointerMove;
//             console.log(answer)
//         }else if(i === 'N') {
//             answer += 13 + pointerMove;
//             console.log(answer)
//         } else if(alphabet[i] <= alphabet['N']) { // N 이전 알파벳인 경우
//             answer += alphabet[i] + pointerMove;
//             console.log(answer)
//         } else { // N 이후 알파벳인 경우
//             answer += (26 - alphabet[i])+pointerMove; // 거꾸로 이동하는 것이므로 26에서 해당 알파벳까지의 거리를 빼줌
//             console.log(answer)
//         }
//     }
//     console.log(answer)
